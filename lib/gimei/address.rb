class Gimei::Address
  ...
  class Prefecture
    ...
    def initialize
      @prefectures = Gimei::ADDRESSES['addresses']['prefecture'].sample(random: Gimei::Config.random)
    end
  ...
  class City
    ...
    def initialize
      @cities = Gimei::ADDRESSES['addresses']['city'].sample(random: Gimei::Config.random)
    end
  ...
  class Town
    ...
    def initialize
      @towns = Gimei::ADDRESSES['addresses']['town'].sample(random: Gimei::Config.random)
    end
